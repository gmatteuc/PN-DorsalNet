...
% NB: from here on add unclassified as predictor/predicted (and try
% categorical way of assessing perf too)
% TODO: break the function in a loop to make sure predicted matrix has less
% than 100 rows for each run
...
%% compare patt. and comp. with quasi-patt. and quasi-comp. garnd averages ----------------
...
% save
saveas(fighand1quater,[resultpath,filesep,'quasi_classification_diagnostics_bis'],'jpg')
print(fighand1quater,'-depsc','-painters',[resultpath,filesep,['quasi_classification_diagnostics_bis'],'.eps'])

% TODO??: try to visualize in the same way other representations (e.g. predictions)
...
% TODO???: do comparison barplot for rdm analysis (bootstrap over neurons for significance)
% TODO???: try with generation of #neurn equalized pseudopopulations as preprocessing
