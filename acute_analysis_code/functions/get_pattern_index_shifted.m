function [ PI, PIgen, Zp, Zc, Rp, Rc, Zpgen, Zcgen, Rpgen, Rcgen ] = ...
    get_pattern_index_shifted( tuning_curve_grating,tuning_curve_plaid,shift )
...
Resp_Grat1_raw = circshift(tun_vector',-angle_shift_to_apply+shift)';
Resp_Grat2_raw = circshift(tun_vector',angle_shift_to_apply+shift)';
Resp_Plaid0_raw = circshift(tun_vector',0+shift)';

%------------------- non-canonical indeces --------------------------------
PDSrev_prediction = circshift(Resp_Plaid0_raw',-angle_shift_to_apply)';
PDSori_prediction = (PDSrev_prediction +  Resp_Plaid0_raw)/2;
%--------------------------------------------------------------------------
...
PDS_prediction = Resp_Plaid0_raw; % pattern prediction
